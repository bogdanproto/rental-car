...
const adverts = [
  ...
  },
  {
    ...
    description:
      'The Kia Ceed is a versatile and fuel-efficient vehicle available in both sedan and hatchback body styles, offering a comfortable cabin, modern features, and a smooth driving experience, making it an attractive choice for urban commuters.',
    fuelConsumption: '10.2',
    engineSize: '3.6L 8-cylinder',
    accessories: [
      'Apple CarPlay and Android Auto integration',
      'Smart Key with Push Button Start',
      'Automatic climate control',
    ],
    functionalities: ['Front-Wheel Drive'],
    rentalPrice: '$200',
    rentalCompany: 'Power Car Rentals',
    address: '321 Example Lane, Lviv, Ukraine',
    rentalConditions:
      "Minimum age: 21\nValid driver's license\nSecurity deposit and insurance required",
    mileage: 100,
  },
  {
    ...
    img: 'https://ftp.goit.study/img/cars-test-task/kia_rio_sedan_hatchback.jpeg',
    description:
      'The Kia Ceed Electric is a versatile and fuel-efficient vehicle available in both sedan and hatchback body styles, offering a comfortable cabin, modern features, and a smooth driving experience, making it an attractive choice for urban commuters.',
    fuelConsumption: '0.0',
    engineSize: 'electric',
    accessories: [
      'Apple CarPlay and Android Auto integration',
  ...
  },
  {
    ...
    img: 'https://ftp.goit.study/img/cars-test-task/kia_rio_sedan_hatchback.jpeg',
    description:
      'The Kia Rio Electric is a versatile and fuel-efficient vehicle available in both sedan and hatchback body styles, offering a comfortable cabin, modern features, and a smooth driving experience, making it an attractive choice for urban commuters.',
    fuelConsumption: '0.0',
    engineSize: 'electric',
    accessories: [
      'Apple CarPlay and Android Auto integration',
  ...
  },
  {
    ...
    fuelConsumption: '6.0',
    engineSize: '1,2',
    accessories: ['Smart Key with Push Button Start'],
    functionalities: ['Front-Wheel Drive'],
    rentalPrice: '$20',
    rentalCompany: 'Power Car Rentals',
    address: '321 Example Lane, Lviv, Ukraine',
